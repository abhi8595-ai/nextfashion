            ...
            <div
              ...
              <div
                ...
                <div class="dark:bg-white/10 bg-white/50 dark:hover:bg-white/30 hover:bg-white/100 transition-all rounded-full p-0.5 w-5 h-5 flex items-center justify-center">
                  <UIcon size="14" name="i-iconamoon-sign-plus" class="text-black dark:text-white cursor-pointer" @click="increment(product?.variation?.node?.databaseId || 0)" />
                </div>
                ...
                <div class="dark:bg-white/10 bg-white/50 dark:hover:bg-white/30 hover:bg-white/100 transition-all rounded-full p-0.5 w-5 h-5 flex items-center justify-center">
                  <UIcon
                    ...
                    @click="decrement(product?.variation?.node?.databaseId || 0)" />
                </div>
              </div>
            </div>
          </div>
